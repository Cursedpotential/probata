...
- Nine unit tests passed for store selection, unavailable-store provenance and recovery actions, memsearch credential-health reporting, persisted agent packets, the exact MCP catalog, bounded concurrent locking, and active-WAL safety.
